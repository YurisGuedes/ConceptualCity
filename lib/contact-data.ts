...
export const contactData: Record<Lang, ContactInfo> = {
  pt: {
    ...
    whatsappHref: `https://wa.me/351932176872?text=${encodeURIComponent(
      "Olá, vim do website da Conceptual City e gostaria de mais informações sobre o serviço."
    )}`,
  ...
  es: {
    ...
    whatsappHref: `https://wa.me/34649803134?text=${encodeURIComponent(
      "Hola, vengo de la web de Conceptual City y me gustaría más información sobre el servicio."
    )}`,
